package com.smartech.invoicekeeper.loader;
...
public class InvoiceListViewLoader extends ListActivity
    ...
    static final String[] PROJECTION = new String[] {InvoiceContract.Invoice._ID,
            InvoiceContract.Invoice.COLUMN_NAME_TITLE};

    // This is the select criteria
    static final String SELECTION = "((" +
            InvoiceContract.Invoice.COLUMN_NAME_TITLE + " NOTNULL) AND (" +
            InvoiceContract.Invoice.COLUMN_NAME_TITLE + " != '' ))";
